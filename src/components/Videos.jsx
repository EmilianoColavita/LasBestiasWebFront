      ...
      <div className="relative max-w-6xl mx-auto text-center">
        ...
        <div className="flex justify-center mb-8">
          <div className="w-full md:w-3/4 lg:w-2/3">
            <iframe
              className="rounded-2xl shadow-2xl w-full h-[220px] md:h-[400px]"
        ...
        <div className="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto md:overflow-visible snap-x snap-mandatory pb-4">
          {otros.slice(0, 6).map((video) => (
            ...
            >
              ...
              <h4 className="text-yellow-400 font-bold text-sm mt-3">
                {video.titulo}
              </h4>
            </div>
          ))}
